...
from showtimes.views import ScreeningListView, ScreeningView, CinemaListView, CinemaView
...
urlpatterns = [
    ...
    url(r'^screenings/$', ScreeningListView.as_view()),
    url(r'^screenings/(?P<pk>[0-9]+)/$', ScreeningView.as_view()),
